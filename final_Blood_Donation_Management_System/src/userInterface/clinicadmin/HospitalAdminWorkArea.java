...
public class HospitalAdminWorkArea extends javax.swing.JPanel {
    ...
    private void btnManageEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEmployeeActionPerformed
        if(enterprise.getOrganizationDirectory().getOrganizationList().size()==0){
            JOptionPane.showMessageDialog(null, "Create Organization");
            return;
        }
    ...
    private void btnManageUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageUserActionPerformed
        ...
        if(size == 0){
            ...
            for(int i = 0; i < size; i++){
                if(enterprise.getOrganizationDirectory().getOrganizationList().get(i).getEmpDetails().getEmployeelist().size() > 0)
                    flag = true;
            }
        }
        if(flag){
            ...
            JOptionPane.showMessageDialog(null, "Create Employee for user Management");
        }
