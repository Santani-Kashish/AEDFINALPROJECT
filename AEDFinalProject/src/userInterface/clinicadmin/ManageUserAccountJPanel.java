...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountJPanel(JPanel container, Enterprise enterprise) {
        ...
        this.enterprise = enterprise;
         ...
         popData();
         tblUser.getTableHeader().setFont(new Font("Baskerville" , Font.ITALIC,20));
    }
    ...
    private void btnCreateUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateUserActionPerformed
      String userName = nameJTextField.getText();
        ...
        Organization organization = (Organization) JComboBoxOrganization.getSelectedItem();
        PersonEntity employee = (PersonEntity) JComboBoxEmployee.getSelectedItem();
        AdminTitle role = (AdminTitle) JComboBoxRole.getSelectedItem();
        ...
        MainAcc account = organization.getData().createAccount(userName, password, employee, role);
    ...
    public void populateEmployeeComboBox(Organization organization){
        ...
        for (PersonEntity employee : organization.getEmpDetails().getEmployeelist()){
    ...
    private void populateRoleComboBox(Organization organization){
        ...
        for (Title role : organization.getTitle()){
    ...
    private void popData() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            for (MainAcc ua : organization.getAccountDirectory().getUserAccountList()) {
