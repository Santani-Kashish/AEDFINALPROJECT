...
public class TransportationAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public TransportationAdminWorkAreaJPanel(JPanel rightPanel, Account account, Organization organization,Enterprise enterprise, ECOSystem business) {
        initComponents();
        this.rightPanel = rightPanel;
        this.account = account;
        this.business = business;
        this.organization = (TransportationAdminOrganization)organization;
    ...
    public TransportationAdminWorkAreaJPanel(JPanel rightPanel, Account account, Enterprise enterprise, ECOSystem business) {
        initComponents();
        this.rightPanel = rightPanel;
        this.account = account;
        this.business = business;
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        {
             JOptionPane.showMessageDialog(null, "No delivery man to assign", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
       ...
       populateTable();
        JOptionPane.showMessageDialog(null, "Request has been assigned to delivery man", "Warning", JOptionPane.WARNING_MESSAGE);
