 ...
 * @author kashish
 */
public class HandleBloodRequest extends javax.swing.JPanel {
     ...
     */
    public HandleBloodRequest(JPanel rightPanel, Environment system, List<Donor> donorList,MainAcc account,Organization organization, Enterprise enterprise) {
        initComponents();
        ...
        this.enterprise = enterprise;
         ...
         tbldonorInfo.getTableHeader().setFont(new Font("Baskerville" , Font.ITALIC,20));
         recipiemtRequestInfo.getTableHeader().setFont(new Font("Baskerville" , Font.ITALIC,20));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userInterface/AdminWorkSpace/Images/hospital.png"))); // NOI18N
        jLabel1.setText(" ");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 460, -1, -1));
    ...
    private void BtnFindMatchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnFindMatchActionPerformed
        ...
        if(selectedRow >= 0){
              Request request = (Request)recipiemtRequestInfo.getValueAt(selectedRow, 0);
        ...
        if(latestDonars.size() > 0)
        {
            ...
            JOptionPane.showMessageDialog(null, "Match has been Found", "successful", JOptionPane.WARNING_MESSAGE);
        }
             
        else
        {
         
             JOptionPane.showMessageDialog(null, "Match hasn't been Found", "WARNING_MESSAGE", JOptionPane.WARNING_MESSAGE);
        ...
        populateRecipientTable();
            ...
            JOptionPane.showMessageDialog(null, "Please select a Blood request", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void btnInformActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInformActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            JOptionPane.showMessageDialog(null, "Match information has been Emailed to Donor & Receiver");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        ManageBloodJPanel managePlasmaJPanel = new ManageBloodJPanel(rightPanel, account,organization,enterprise,system);
    ...
    private void populateRecipientTable() {
        ...
        model.setRowCount(0);
         ...
         for(Request request : system.getWorkQueue().getWorkRequestList()){
             if(request.getReceiver() != null && request.getStatus().equals("In Process"))
             {
